...
class Ui_CosmoWindow(object):
    def setupUi(self, CosmoWindow):
        ...
        self.label.setGeometry(QtCore.QRect(40, 410, 61, 30))
        font = QtGui.QFont()
        font.setFamily("Latin Modern Sans")
        font.setPointSize(11)
        ...
        self.TE_Help.setGeometry(QtCore.QRect(0, 30, 511, 471))
        ...
        self.PB_Help.setGeometry(QtCore.QRect(0, 0, 88, 34))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/flagUK.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.PB_Help.setIcon(icon)
        self.PB_Help.setObjectName("PB_Help")
        self.PB_Hilfe = QtWidgets.QPushButton(self.Tab_Help)
        self.PB_Hilfe.setGeometry(QtCore.QRect(420, 0, 88, 34))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/flagDE.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.PB_Hilfe.setIcon(icon1)
    ...
    def retranslateUi(self, CosmoWindow):
        ...
        self.pB_FileSelect.setToolTip(_translate("CosmoWindow", "<html><head/><body><p>select DAQ configuration file</p></body></html>"))
        ...
        self.Tab_Help.setToolTip(_translate("CosmoWindow", "<html><head/><body><p>Info &amp; Help / Hilfe </p></body></html>"))
